...
class PopupApp {
    ...
    mainElement.innerHTML = `
      <div class="text-center space-y-4">
        ...
        <div>
          ...
          <p class="text-gray-300 mt-2">You're on ${this.state.currentSite}. Navigate to a movie or show to start monitoring jumpscares.</p>
        </div>
        <div class="bg-card-bg p-4 rounded-lg">
          <p class="text-sm text-gray-400">Status: Waiting for content selection</p>
        </div>
      </div>
    `;
  }
  ...
  private renderMovieDetectedPage(): void {
      ...
      mainElement.innerHTML = `
        <div class="text-center space-y-4">
          ...
          <div>
            ...
            <p class="text-gray-300 mt-2">Detecting movie information...</p>
          </div>
        </div>
      `;
      return;
    ...
    const statusText = movie.isInDb
      ...
      : "This movie is not in our database yet.";
    ...
    mainElement.innerHTML = `
      <div class="text-center space-y-4">
        ...
        <div>
          ...
          <p class="text-gray-300 mt-2">Monitoring jumpscares on ${
            this.state.currentSite
          }</p>
          ${
            this.state.movie
      ...
      <div class="space-y-4">
        ...
        <div class="space-y-3">
          <div class="flex items-center justify-between">
            ...
            <select class="bg-card-bg border border-gray-600 rounded px-2 py-1 text-sm">
          ...
          <button class="w-full bg-accent hover:bg-orange-600 text-white py-2 rounded transition-colors">
            Save Settings
          </button>
        </div>
      </div>
